...
use dbboard_config::{default_ai_providers_path, AiProviderKind, AiSettingsAdmin, ConnectionKind};
...
mod tests {
    ...
    //! is the wiring: dialect derivation, the stream fold, and the JSON shapes
    //! the panel parses. These pin exactly that.
    use super::*;
