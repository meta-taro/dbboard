...
| Schema diff between two connections | ➖ | ✅ | ADR-0148 / ADR-0149. Desktop **leads** egui: a third **Compare** tab. Same engine only, refused before either side is dialled; types compared exactly as spelled. The sidebar marks the tables the report mentions and jumps into it, and never filters or replaces it. |
