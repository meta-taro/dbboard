...
- 状態: open。**(c) は実施済み**（2026-09-10、ADR-0153 — 文書を実態に合わせた）。
  **a / b の選択は未決**で、v1.0 の contract 凍結より前に決める必要がある
...
| c | ~~**「予約済み・未実装」と明記する**~~ | **2026-09-10 実施**（ADR-0153）。roadmap の項目は「出荷され、その後消えた」と読める形にし、原文は残した（書かれた当時は真だったので）。`default_history_path` の doc にも「誰も書いていない」と明記 |
