...
- 日付: 2026-07-17
- develop tip: `bcd7db1` (PR #86 まで merged)。main = v0.2.0 タグ (`891d2cc`)。
...
- **MSI で渡す場合**: PR #52 で MSI ソース揃済。WiX v3 + `cargo install
  cargo-wix` → `cd apps/dbboard && cargo wix`。exe 単体で十分なら不要。
